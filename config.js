const config = {
    ...
    "agents": [
      {
        ...
        "contactDetails": [
          {
            "type": "email",
            "value": "chantel@chantelcrispteam.com"
          },
          {
            "type": "phone",
  ...
  "mainBox": {
    "summary": {
      ...
      "subTitle": "Summary",
      "paragraphs": [
        "Meet a young couple who started 2025 with zero plans to buy a home. One had just finished nursing school and landed a full-time position, while the other had an established career with Apple. They'd been renting in downtown Toronto for years, convinced that homeownership in the city was a dream reserved for others, not them.",
        "Through professional service and market expertise, we delivered exceptional results for our client. <strong>WON AGAINST MULTIPLE OFFERS</strong> in one of Toronto's most competitive price points and neighbourhoods Secured a fully-renovated, 3-bedroom semi-detached home with a dream backyard, finished basement with separate entrance, and even a shed that could be converted into a future rental suite <strong>PURCHASED FOR $1,250,000</strong>, a strong offer in a strategic pricing scenario that reflected true market value, not an overpay Closed in just over 2 months with zero stress, zero hidden issues, and every single one of their must-haves checked off <strong>ACHIEVED THE IMPOSSIBLE:</strong> Went from \"we'll probably just rent a bigger apartment\" to owning their dream freehold home in the city on their very first showing The sellers later revealed that even if another offer had been higher, they still would have chosen our buyers because of how meaningful and heartfelt their letter was"
      ]
    },
    "sidebar": {
